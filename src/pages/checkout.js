    ...
    <div className='container px-2 sm:m-auto'>
      ...
      <div className="px-2 w-full">
        <div className="mb-4">
          ...
          <textarea cols="30" rows="2" id="address" name="address" className="w-full bg-white rounded border border-gray-300 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"></textarea>
        </div>
      </div>
      ...
      <div className="mx-4">
        <Link href={'/checkout'}><button className="flex mt-2 text-white bg-pink-500 border-0 py-2 px-2 focus:outline-none hover:bg-pink-600 rounded text-sm mr-2"><BsFillBagCheckFill className='m-1' />Pay रू{subTotal}</button></Link>
      </div>
    </div>
  )
}
